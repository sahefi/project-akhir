...
class Home extends React.Component {
  constructor() {
    ...
    if(localStorage.getItem('token')){
      ...
      this.state.adminName = localStorage.getItem('name')
    }else{
        ...
        return (
          <div>
                ...
                <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                  <div className="sm:text-center lg:text-left">
                    <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                      <span className="block xl:inline">Hi {this.state.adminName},</span>
                    </h1>
            ...
            <div className="lg:absolute lg:inset-y-0 lg:right-0  col-7">
              <img
                className="h-56 w-full object-cover sm:h-80 md:h-96 lg:w-full lg:h-full"
